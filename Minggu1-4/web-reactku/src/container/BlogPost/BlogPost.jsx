...
class BlogPost extends Component {
    ...
    handleEditArtikel = (data) => {        // Fungsi yang meng-handle button action hapus data
        fetch('http://localhost:3001/posts/${data}', {method: 'EDIT'})        // Alamat URL API yang ingin kita HAPUS datanya
            .then(res => {      // Ketika proses hapus berhasil, maka ambil data dari server API lokal
                this.ambilDataDariServerAPI()
            })
    }
            ...
            <div className="post-artikel">
                ...
                <h2>Daftar Artikel</h2>
                {
                    this.state.listArtikel.map(artikel => {
                        ...
                        idArtikel={artikel.id} EditArtikel={this.handleEditArtikel}/>
                    })
                }
