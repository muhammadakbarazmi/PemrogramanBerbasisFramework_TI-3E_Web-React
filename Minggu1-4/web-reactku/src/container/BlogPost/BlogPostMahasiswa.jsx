...
class BlogPostMahasiswa extends Component{
    ...
    handleHapusMahasiswa = (data) => {
        ...
        fetch(`http://localhost:3002/mahasiswa/${mahasiswa.id}`, {method: 'DELETE'})
            .then(res => {
                this.ambilDataDariServerAPI()
            })
        })
    ...
    handleEditMahasiswa = (data) => {
        fetch(`http://localhost:3002/mahasiswa/${data}`, {method: 'EDIT'})
            .then(res => {
                this.ambilDataDariServerAPI()
            })
    }
        ...
        return(
            <div className="post-mahasiswa">
                <div className="form pb-2 border-bottom">
                    ...
                    <button type="submit" className="btn btn-primary" onClick={this.handleHapusMahasiswa}>Hapus</button>
                </div>
                <h2>Daftar Mahasiswa</h2>
                {
                    this.state.listMahasiswa.map(mahasiswa=> {
                        ...
                        EditMahasiswa={this.handleEditMahasiswa}/>
                    })
                }
            </div>
        )
